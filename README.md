...
## General Structure
The project contains 2 main modules: [Logic](https://github.com/sharif-ml-lab/IMDb-IR-System/blob/main/Logic/README.md) and [UI](https://github.com/sharif-ml-lab/IMDb-IR-System/blob/main/UI/README.md). The `Logic` module is responsible for doing the main tasks of the project and the `UI` module is responsible for providing a user interface for the user to interact with the system. In each task, you will be told to implement a part or a whole file in one of these modules. Please read the comments for each file and functions inside it to understand what you need to do.